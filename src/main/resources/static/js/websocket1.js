            ...
            console.log(users[i]['other'])
                if (userId==users[i]['other']){
                    ...
                    usersTemplateHTML = usersTemplateHTML +
                        '<a class="list-group-item list-group-item-action" id="child_message" onclick="formMessageLauch(\'' + users[i]['my'] + '\', \'' + users[i]['myNickName'] + '\', \'user\', \'' + users[i]['title'] + '\', \'' +  users[i]['price'] + '\', \'' + users[i]['thumbnail'] + '\')" data-userid="' + users[i]['myNickName'] + '" data-type="user" data-thumbnail="' + users[i]['thumbnail'] + '" data-title="' + users[i]['title'] + '" data-price="' + users[i]['price'] + '">' +
                    ...
                    usersTemplateHTML = usersTemplateHTML +
                        '<a class="list-group-item list-group-item-action" id="child_message" onclick="formMessageLauch(\'' + users[i]['other'] + '\', \'' + users[i]['otherNickName'] + '\', \'user\', \'' + users[i]['title'] + '\', \''  + users[i]['price'] + '\', \'' + users[i]['thumbnail'] + '\')" data-userid="' + users[i]['otherNickName'] + '" data-type="user" data-thumbnail="' + users[i]['thumbnail'] + '" data-title="' + users[i]['title'] + '" data-price="' + users[i]['price'] + '">' +
                        '<img src="https://via.placeholder.com/50" alt="User Image" width="50px" height="50px" class="rounded-circle">'+
...
function formMessageLauch(id,name,type,title,price,thumbnail){
